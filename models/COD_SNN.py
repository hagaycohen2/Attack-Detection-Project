...
# Example running
# python COD_SNN.py -t datasets/MTA/train_mta_data_new_12f.csv -s models/saved_models/COD_SNN/

# Example with full path:
# python C:\Users\tnrha\Attack-Detection-Project\models\COD_SNN.py -t C:\Users\tnrha\Attack-Detection-Project\datasets/MTA/train_mta_data_new_12f.csv -s C:\Users\tnrha\Attack-Detection-Project\models\saved_models\COD_SNN\