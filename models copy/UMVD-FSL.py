...
def main():
    ...
    X_train, y_train_main, y_train_secondary, num_main_classes, num_secondary_classes = load_data_as_images(
        r'C:\Users\User\Attack-Detection-Project\datasets\MTA\train_small.csv',
        image_size,
        r'C:\Users\User\Attack-Detection-Project\models copy\saved_models\UMVD-FSL\\'
    )
    train_umvd_fsl(X_train, y_train_main, y_train_secondary, num_main_classes, num_secondary_classes, image_size, r'C:\Users\User\Attack-Detection-Project\models copy\saved_models\UMVD-FSL\\')
