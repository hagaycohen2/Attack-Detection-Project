...
def main():
    train_path = r'C:\Users\User\Attack-Detection-Project\datasets\MTA\train_small.csv'
    save_path = r'C:\Users\User\Attack-Detection-Project\models copy\saved_models\COD_SNN\\'
    train_and_save_siamese_network(train_path, save_path)
