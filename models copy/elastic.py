...
# example usage:
# python models copy\elastic.py -n 12 --test C:\Users\User\Attack-Detection-Project\datasets\MTA\test_mta_data_new_12f --train C:\Users\User\Attack-Detection-Project\datasets\MTA\train_small --metric max_inner_product